...
# --- Helper Function 2: Fingerprint Calculation ---
...
# --- Helper Function 3: Instruction Formatting ---
...
#python generate_regression_prompts.py \
#    --input_csv /path/to/esol_train.csv \
#    --output_json data/esol_split/train.json \
#    --tokenizer_path /path/to/zinc_tokenizer/vocab.json \
#    --smiles_col smiles \
#    --label_col "measured log solubility in mols per litre" \
#    --task_desc "predict its water solubility (LogS value)" \
#    --num_shots 3